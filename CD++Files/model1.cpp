...
Model1::Model1( const string &name )
: Atomic( name )
...
********************************************************************/
Model &Model1::externalFunction( const ExternalMessage &msg )
{
	if (msg.port() == Uin) {
 		if (haveU == 0) {
			haveU = 1;
...
********************************************************************/
Model &Model1::internalFunction( const InternalMessage & )
{
	passivate();
	return *this ;
}
...
*		
********************************************************************/
Model &Model1::outputFunction( const InternalMessage &msg )
{
