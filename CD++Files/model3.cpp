...
Model3::Model3( const string &name )
: Atomic( name )
...
********************************************************************/
Model &Model3::externalFunction( const ExternalMessage &msg )
{
	if (msg.port() == Uin) {
 		if (haveU == 0) {
			haveU = 1;
...
********************************************************************/
Model &Model3::internalFunction( const InternalMessage & )
{
	passivate();
	return *this ;
}
...
*		
********************************************************************/
Model &Model3::outputFunction( const InternalMessage &msg )
{
